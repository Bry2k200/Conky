...
HTML_color_battery = "#f3f8fa"
HTML_color_drive_1 = "#f3f8fa"
HTML_color_drive_2 = "#f3f8fa"
HTML_background_CPU = "#f3f8fa"
HTML_color_RAM = "#f3f8fa"
HTML_color_BORDER = "#f3f8fa"
transparency_battery = 1.0
transparency_drive_1 = 1.0
transparency_drive_2 = 1.0
transparency_CPU = 1.0
transparency_RAM = 1.0
...
drive_paths = {"/home/bry2k200/Media", "/home/Media"}

-- Names of drives for free space status.
drive_names = {"MEDIA", "HDD2"}
